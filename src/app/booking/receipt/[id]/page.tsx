      ...
      <div className="pt-24 pb-12">
        {status === "loading" && (
          <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
            ...
            <p className="font-bold text-ink">Loading receipt…</p>
          </div>
        )}
        ...
        {status === "error" && (
          <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center px-4">
            ...
            <div>
              <p className="font-bold text-ink text-lg">Receipt unavailable</p>
        ...
        {status === "success" && booking && (
          <div className="w-full max-w-4xl mx-auto px-4 py-8">
            ...
            <Link
              href="/profile"
              className="inline-flex items-center gap-1.5 text-sm font-medium mb-6 transition-colors hover:text-brand"
              style={{ color: "#46524D" }}
            >
